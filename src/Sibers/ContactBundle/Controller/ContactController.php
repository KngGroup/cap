...
namespace Sibers\ContactBundle\Controller;
...
use Sibers\ContactBundle\Form\ContactType;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SibersContactBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("SibersContactBundle:Contact:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SibersContactBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SibersContactBundle:Contact:edit.html.twig")
     */
